namespace CreatorUSBKey {
  partial class CreatorUSBKey {
    ...
    private void InitializeComponent() {
      ...
      this.label2.Text = "Владелец ключа";
      // 
      // textBox1
      // 
      ...
      this.label3.Text = "Кол-во активаций";
      // 
      // button1
      // 
      ...
      this.Name = "CreatorUSBKey";
      this.ShowIcon = false;
      this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
      this.Text = "Генератор USB ключей v.1.2";
